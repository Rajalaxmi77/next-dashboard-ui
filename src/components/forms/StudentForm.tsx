...
import { createStudent, createTeacher, updateStudent, updateTeacher } from "@/lib/action";
...
const StudentForm = ({
  ...
  return (
    <form className="flex flex-col gap-8" onSubmit={onSubmit}>
      ...
      {state.error && <span className="text-red-500">An error occurred. Please try again.</span>}
